...
luci-app-xlnetacc luci-app-vlmcsd luci-app-wol luci-app-ramfree luci-app-ttyd luci-app-sqm luci-app-rclone\
luci-app-sfe luci-app-nlbwmon luci-app-accesscontrol luci-app-cpufreq luci-app-softethervpn
# For the basic set
